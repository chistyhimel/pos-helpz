...
const ProductViewTable = () => {
    ...
    useEffect(() => {        
            axios
                .get(`https://mudee.shop/helpz/api/customer/list/pos`)
                .then(res => {
                    // console.log(res);
        ...
        <div className="ProductViewTableBody">
            <div className="inputHeader">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <input onKeyUp={handleChange} name="name" ref={register} placeholder="Product Name" />
                    <input onKeyUp={handleCustomer} name="customerName" ref={register} placeholder="Customer Name" />
            ...
            <div className="Products">
                ...
                <div className="allProducts">

                    {
                        ...
                        search.length == 0 ? initialProduct.map(item =>
                            <Card onClick={() => handleCount(productInfo, setProductInfo, item)} className={classes.root}>
                                <CardActionArea>
                                    <CardMedia
                                        className={classes.media}
                                        image={"https://mudee.shop/helpz/assets/images/products/" + item.photo}
                                    ...
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" color="textSecondary" component="p">
                                            <small>Price:</small> <strong>{item.price} Tk. </strong> <br />
                                            <small>Stock:</small><strong>{item.stock}</strong><br />
                                        </Typography>
                                    </CardContent>
                                </CardActionArea>
